...
export const DEFAULT_DEAL_BANNERS: DealBanner[] = [
  {
    ...
    strainLines: [
      "H: Zesty Citrus, Cookie Cream, Oreo",
      "I: Blueberry Kush, Rainbow Sherbet, Mars OG, UK Cheese",
    ],
  ...
  },
  {
    ...
    titleLine1: "3oz for",
    titleLine2: "$190",
    description: "+ 14g FREE + 6pc edible FREE. Carefully hand-selected, high quality strains.",
    strainLines: [
      "S: Pineapple Express, Cherry Pie",
      "H: Oreo, Grape Cake, Sour Grape",
      "I: Blueberry Kush, Pink Runtz, Ice Cream Gelato, Gorilla",
    ],
    limitText: "Limit 1oz per customer",
    badges: ["Quality BUDS", "Free Delivery", "Cash & e-Transfer"],
    buttonLabel: "Shop Now",
  ...
  },
  {
    ...
    titleLine1: "2oz for",
    titleLine2: "$110",
    description: "+ free gift. Hand-selected Hybrid & Indica strains.",
    strainLines: [
      "H: Zesty Citrus, Cookie Cream",
      "I: Blueberry Kush, Rainbow Sherbet, Mars OG, UK Cheese",
    ],
    limitText: "Limit 1oz per customer",
    badges: ["Quality BUDS", "Free Delivery", "Cash & e-Transfer"],
  ...
  },
  {
    ...
    titleLine1: "2 for",
    titleLine2: "$140",
    description: "+ free gift. Carefully hand-selected, high quality strains.",
    strainLines: [
      "S: Pineapple Express, Cherry Pie",
      "H: Oreo, Grape Cake, Sour Grape",
      "I: Blueberry Kush, Pink Runtz, Ice Cream Gelato, Gorilla",
